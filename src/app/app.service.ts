...
export class AppService {
  ...
  async signUp(userDto: UserSignUpDto): Promise<ResponseType<UserSchemaType, SessionsSchemaType>> {
  ...
  async login(userDto: UserLoginDto): Promise<ResponseType<UserSchemaType, SessionsSchemaType>> {
    const { email } = userDto
